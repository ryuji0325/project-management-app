                      ...
                      child: Center(
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              // 1. KPI GRID (Financial ROI, Schedule Variance, Active Count, Avg Health)
                              _buildKPIGrid(
                                _activeProjects,
                                _totalProjects,
                                _portfolioROI,
      ...
      builder: (context, constraints) {
        ...
        return GridView.count(
          ...
          children: [
            ...
            _buildKPICard(
              'SCHEDULE VAR',
              variance == 0 ? 'On Track' : '+${variance.toStringAsFixed(1)}d behind',
              variance == 0 ? const Color(0xFF10B981) : Colors.orangeAccent,
        ...
        children: [
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final double health = p['health'];
              final int variance = p['variance'];
              final double roi = p['roi'];
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: _breakoutGridItem(
                            "Schedule Var",
                            variance == 0 ? "On Track" : "+${variance}d behind",
                            variance == 0 ? const Color(0xFF10B981) : Colors.orangeAccent,
                          ),
                        ),
                        const SizedBox(width: 8),
